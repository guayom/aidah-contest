...
RSpec.describe ParametersController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested parameter as @parameter" do
      parameter = Parameter.create! valid_attributes
      get :show, params: {id: parameter.to_param}, session: valid_session
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Parameter" do
        expect {
          post :create, params: {parameter: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved parameter as @parameter" do
        post :create, params: {parameter: invalid_attributes}, session: valid_session
        expect(assigns(:parameter)).to be_a_new(Parameter)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested parameter" do
        parameter = Parameter.create! valid_attributes
        put :update, params: {id: parameter.to_param, parameter: new_attributes}, session: valid_session
        parameter.reload
      ...
      it "assigns the requested parameter as @parameter" do
        parameter = Parameter.create! valid_attributes
        put :update, params: {id: parameter.to_param, parameter: valid_attributes}, session: valid_session
        expect(assigns(:parameter)).to eq(parameter)
      end
    ...
    context "with invalid params" do
      it "assigns the parameter as @parameter" do
        parameter = Parameter.create! valid_attributes
        put :update, params: {id: parameter.to_param, parameter: invalid_attributes}, session: valid_session
        expect(assigns(:parameter)).to eq(parameter)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested parameter" do
      parameter = Parameter.create! valid_attributes
      expect {
        delete :destroy, params: {id: parameter.to_param}, session: valid_session
      }.to change(Parameter, :count).by(-1)
    end
